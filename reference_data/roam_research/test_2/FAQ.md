...
- If you are unsure at all, you are welcome to cancel anytime (here's a guide on [how to cancel your free trial](Cancelling%20your%20membership%20during%20your%20free%20trial.md)).
...
- That's it, you can now [keep on Roaming](keep%20on%20Roaming.md) for the months and years ahead!
...
- [Cancelling your membership during your free trial](Cancelling%20your%20membership%20during%20your%20free%20trial.md)
...
### **What's the difference between hosted vs** [Local Graph](Local%20Graph.md)?
...
- If you need to make some blocks private, you can use our [Encrypted Block](Encrypted%20Block.md) feature. 
...
### **How do I delete a** [page](Pages.md)?
- There are different ways to delete a page: 
- From the [All Pages](All%20Pages.md) view 
    - ((R-H_tHL26))
...
### **How can I make a** [block reference](Block%20References.md)?
- **Method 1**
    - Type `(())`
...
- **Method 3**
    ...
    - Paste the block ref
### **How do I toggle** [Quick Capture](Quick%20Capture.md) **on mobile?**
...
- [4ouk7AXVN](Upload%20Files.md)
- More here: [Upload Files](Upload%20Files.md)
### **What formats does Roam support when uploading images?**
- Currently supported formats include jpg and png.
### **Why are some of my** [Daily Notes](Daily%20Notes.md) **missing?**
...
### **Why can't I hear the** [Pomodoro timer](Pomodoro%20timer.md) **bell sound?**
- In order for the pomodoro bell sound to go off, the timer needs to be in a page that's currently **open** in your graph.
- Here's an example:
    - I start a pomodoro timer, and the block is on my [Daily Notes](Daily%20Notes.md) page for the day.
    - While working I open other pages
    - If at the end of the pomodoro session I haven't returned to my [Daily Notes](Daily%20Notes.md) view, **I won't hear the sound**
- The solution is fairly simple:
    - Once you decide the page where you want your pomodoro timer to live, open that same page in the [right sidebar](Right%20Sidebar.md), so that your timer will always stay in an open page.
### **How to do I paste text in a single block?**
- In order to paste content using [soft line breaks](Adding%20soft%20line%20breaks%20in%20a%20block.md), use `ctrl-shift-v`.
...
- Check out [Notable Graphs](Notable%20Graphs.md) for public graphs by our community
- Check out [Roam Book Club](Roam%20Book%20Club.md) for our own experiment with multiplayer
...
- You can also [encrypt your graph](Encrypted%20Graphs.md)
### **Do you offer end-to-end encryption?**
- Yep. See [Encrypted Graphs](Encrypted%20Graphs.md)
...
### **What's your security standards and** [Privacy Policy](Privacy%20Policy.md)**?**
- Roam's data is hosted by Google, encrypted at rest, and encrypted over the wires.
- ﻿We follow industry best practices for encryption - same as Evernote and Notion - but we make an additional guarantee in our [Privacy Policy](Privacy%20Policy.md) to not ever read your notes without your permission.
- If you want more thorough encryption, you can use the [Encrypted Block](Encrypted%20Block.md). For more details on how we treat our users data, you can see our [Privacy Policy](Privacy%20Policy.md).
### **Where do I find the newest feature updates and bug fixes?**
- Please check our [Change Log](Change%20Log.md)
...
- If no one has reported the issue you are seeing, please file a [bug report](Bug%20Report.md) by [clicking here and filling out this template](https://github.com/Roam-Research/issues/issues/new?assignees=&labels=bug&template=bug_report.md&title=).
...
### **How do I migrate from the Intel **[Desktop App](Desktop%20App.md)** to the Apple Silicon (M1) desktop app?**
