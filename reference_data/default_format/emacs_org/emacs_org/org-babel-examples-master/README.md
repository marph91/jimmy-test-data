...
1.  Babel examples for various backends
    - [Emacs lisp](./lisp-babel.org)
    - [python](./pythonbabel.org) ([PDF](./pythonbabel.pdf) output)
    - [Ipython](./ipython-babel.org)
    - [shell](./shell-babel.org) (bash)
    - [SQLite](./sqlite-babel.org)
    - [Emacs calc](./calc.org)
    - [C](./c-babel.org)
    - [graphviz](./graphviz-babel.org) ([PDF](./graphviz-babel.pdf) output)
    - [plantuml](./plantuml-babel.org)
    - [ditaa](./ditaa-babel.org)
    - [gnuplot](./gnuplot-babel.org)
2.  Export backend Examples
    - [LaTeX](./latex/latex-example.org) ([PDF](./latex/latex-example.pdf) output)
    - [LaTeX Beamer](./beamer-example.org) for presentations ([PDF](./beamer-example.pdf) output)
    - [ODT](./odt-example.org) for exporting to LibreOffice (and then also MS Word) ([ODT](./odt-example.odt) export)
      - [org file to produce an example ODT styles file](./styles.org)
    - [some collected miscellaneous exporter tips](./exporting-tips.org) (just beginning)
3.  general [Org table related](./tables.org) examples
...
- documenting the **installation of servers**. E.g. the complete
  ...
  **Twiki exporter** on our intranet.
  - please also look up Howard Abram's interesting [literate devops](http://www.howardism.org/Technical/Emacs/literate-devops.html)
...
You can also look at the discussion in [this org-mode mailing list thread](http://lists.gnu.org/archive/html/emacs-orgmode/2017-02/msg00443.html).